...
This document contains 32 endpoints under the User tag.
...
**Endpoint:** `GET /api/3/authentication_sources`

## Description
Returns all available sources of authentication for users.

**Operation ID:** `getAuthenticationSources`

## Responses

### 200
**Description:** OK
**Schema:** `Resources«AuthenticationSource»`
...
**Endpoint:** `GET /api/3/authentication_sources/{id}`

## Description
Returns the details for an authentication source.

**Operation ID:** `getAuthenticationSource`
...
**Endpoint:** `GET /api/3/privileges`

## Description
Returns all privileges that may be granted to a role.

**Operation ID:** `getPrivileges`
...
**Endpoint:** `GET /api/3/privileges/{id}`

## Description
Returns the details for a privilege.

**Operation ID:** `getPrivilege`
...
**Endpoint:** `DELETE /api/3/roles/{id}`
...
### 200
**Description:** OK
**Schema:** `CreatedReference«UserID,Link»`
**Example JSON Response:**
```json
{
  "id": 1,
...
**Endpoint:** `DELETE /api/3/users/{id}`

## Description
Deletes a user account.Global Administrator
...
**Endpoint:** `POST /api/3/users/{id}/2FA`
...
**Operation ID:** `regenerateTwoFactorAuthentication`
...
## 20. Asset Groups Access

# Asset Groups Access

**Endpoint:** `GET /api/3/users/{id}/asset_groups`

## Description
Returns the asset groups to which the user has access.

**Operation ID:** `getUserAssetGroups`
...
## 21. Asset Groups Access

# Asset Groups Access

**Endpoint:** `PUT /api/3/users/{id}/asset_groups`
...
**Operation ID:** `setUserAssetGroups`
...
## 22. Asset Groups Access

# Asset Groups Access

**Endpoint:** `DELETE /api/3/users/{id}/asset_groups`

## Description
Revokes access to all asset groups from the user.

**Operation ID:** `removeAllUserAssetGroups`
...
## 23. Asset Group Access

# Asset Group Access

**Endpoint:** `PUT /api/3/users/{id}/asset_groups/{assetGroupId}`
...
**Operation ID:** `addUserAssetGroup`
...
## 24. Asset Group Access

# Asset Group Access

**Endpoint:** `DELETE /api/3/users/{id}/asset_groups/{assetGroupId}`

## Description
Grants the user access to the asset group. Individual asset group access cannot be granted to users with the `allAssetGroups` permission. Global Administrator

**Operation ID:** `removeUserAssetGroup`
...
**Endpoint:** `DELETE /api/3/users/{id}/lock`
...
**Endpoint:** `PUT /api/3/users/{id}/password`
...
**Endpoint:** `GET /api/3/users/{id}/sites`

## Description
Returns the sites to which the user has access.

**Operation ID:** `getUserSites`
...
**Endpoint:** `PUT /api/3/users/{id}/sites`
...
**Endpoint:** `DELETE /api/3/users/{id}/sites`

## Description
Revokes access to all sites from the user.

**Operation ID:** `removeAllUserSites`
...
**Endpoint:** `PUT /api/3/users/{id}/sites/{siteId}`
...
**Endpoint:** `DELETE /api/3/users/{id}/sites/{siteId}`

## Description
Grants the user access to the site. Individual site access cannot be granted to users with the `allSites` permission. Global Administrator

**Operation ID:** `removeUserSite`
